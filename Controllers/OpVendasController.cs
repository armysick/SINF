...
namespace FirstREST.Controllers
{
    public class OpVendasController : ApiController
    {
        ...
        /*
        // GET api/cliente/5    
        public OpVenda Get(string id)
        {
            Lib_Primavera.Model.OpVenda cliente = Lib_Primavera.PriIntegration.GetCliente(id);
            if (cliente == null)
            {
        ...
        public HttpResponseMessage Post(Lib_Primavera.Model.OpVenda cliente)
        {
        ...
        public HttpResponseMessage Put(string id, Lib_Primavera.Model.OpVenda cliente)
        {
